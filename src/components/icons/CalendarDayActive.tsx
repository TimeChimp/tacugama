...
export const CalendarDayActive = ({ title = 'CalendarDayActive', size = defaultIconProps.size, color }: SVGProps) => {
  ...
  return (
    <Icon title={title}>
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M10.7305 10.6797H12.9492V16H11.5195V11.8867H10.7305V10.6797Z"
          fill={color || theme.current.colors.primary}
        />
      </svg>
    </Icon>
