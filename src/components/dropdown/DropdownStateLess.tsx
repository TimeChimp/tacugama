...
//TODO: merge this with regular dropdown
const BaseDropdown = (PopoverComponent: typeof Popover) => {
  return ({
    children,
    items = [],
    showSearch,
...
export const DropdownStateless = BaseDropdown(Popover);
...
//   isOpen,
//   setIsOpen,
// }: Omit<DropdownProps, 'onOpen'> & { onClose: () => void; isOpen: boolean; setIsOpen: (isOpen: boolean) => void }) => {
//   const [searchTerm, setSearchTerm] = useState<string>();
